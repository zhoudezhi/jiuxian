// JavaScript Document
require(["fastclick", "zepto", "template", "helper", "api", "utility", "swiper", "dialog", "toast", "goTop", "md5", "jdShare"], function (attachFastClick, $, template,helper,API_AJAX,utility,Swiper,dialog,toast,goTop,md5,jdShare) {
