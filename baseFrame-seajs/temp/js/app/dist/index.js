// JavaScript Document
define("../js/app/dist/index", [ "zepto", "api", "utility", "swiper", "toast", "dialog", "template", "goTop" ], function(require, exports, module) {
    var $ = require("zepto");
    ...
    API_AJAX.jsonp(articleDate).done(function(res) {
        ...
        $(".match-detail-page").prepend(template.render("jing-detail-tpl", {
            data: result
        }));
        initSlider1();
        getMoreMatch();
    ...
    function getMoreMatch() {
        ...
        API_AJAX.jsonp(data).done(function(res) {
            ...
            $(".more-match-box").html(template.render("more-match-tpl", {
                data: result
            }));
